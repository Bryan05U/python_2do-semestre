...
Además se debe crear varios métodos mágicos que permitan operar, comparar, y mostrar las fracciones de manera intuitiva. La clase debe poseer los siguientes métodos mágicos:
